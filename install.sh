...
echo -e "\033[01;33mpkg install git -y\npkg install nodejs -y\npkg install ffmpeg -y\npkg install imagemagick -y\npkg install -y yarn\ngit clone https://github.com/Whiteelpro/Bot\ncd NovaBot-MD\nyarn install\nnpm install\nnpm start\033[0m"
exit 1
else
...
echo -e "\033[01;33mpkg install git -y\npkg install nodejs -y\npkg install ffmpeg -y\npkg install imagemagick -y\npkg install -y yarn\ngit clone https://github.com/elrebelde21/bot\ncd bot\nyarn install\nnpm install\nnpm start\033[0m"
exit 1
else
...
menu_ayuda() {
	...
	case $opcion in
            01|1)
                am start -a android.intent.action.VIEW https://whatsapp.com/channel/0029VaiTbYP002TD4cYYoQ2D &>> /dev/null
...
┏╍┅┅┅╍⪻ TOP-COLOMBIA ⪼┅┅┅┅┅┓
┋❥ 𝐂𝐫𝐞𝐚𝐝𝐨𝐫 : ewhitex0
┋❥ 𝐘𝐨𝐮𝐭𝐮𝐛𝐞 : www.youtube.com/@ewhitex0
┋❥ 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 : https://www.facebook.com/profile.php?id=61554982045947&mibextid=ZbWKwL
┋❥ 𝐆𝐢𝐭𝐇𝐮𝐛 : github.com/Whiteelpro
┋❥ 𝐌𝐞𝐫𝐜𝐚𝐝𝐨 𝐩𝐚𝐠𝐨, 𝐚𝐥𝐢𝐚𝐬: ewhitexz7 en ig
┋┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅
...
echo -e "\033[01;32m\033[01mＩＮＩＣＩＡＮＤＯ TOP-COLOMBIA🇨🇴 🚀\n\033[0m"
npm start
